...
export function Footer() {
  return (
    <footer className="bg-brand-950 text-slate-300 py-20 border-t border-brand-900">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-brand-900 flex items-center justify-center hover:bg-brand-800 transition-colors">
        ...
        <div className="pt-8 border-t border-brand-900 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-400">© {new Date().getFullYear()} TalentOps. All rights reserved.</p>
