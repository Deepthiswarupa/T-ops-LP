...
export function Footer() {
  return (
    <footer className="bg-[#050505] text-slate-400 py-20 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#e68a6d] to-[#c26243] flex items-center justify-center shadow-sm shadow-orange-500/20">
                <span className="text-white font-bold text-xl leading-none">T</span>
              </div>
              <span className="font-bold text-xl text-white tracking-tight">TalentOps</span>
            </div>
            <p className="text-slate-400 max-w-sm font-serif text-lg leading-relaxed">
              One Intelligent Platform to Manage, Engage, and Grow Your Workforce. Built for modern organizations.
            </p>
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-[#111] flex items-center justify-center hover:bg-orange-500/20 hover:text-orange-400 transition-colors text-slate-400 border border-slate-800">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li><a href="#" className="hover:text-white transition-colors text-sm">Employee Management</a></li>
              <li><a href="#" className="hover:text-white transition-colors text-sm">Payroll</a></li>
              <li><a href="#" className="hover:text-white transition-colors text-sm">Attendance</a></li>
              <li><a href="#" className="hover:text-white transition-colors text-sm">Performance</a></li>
