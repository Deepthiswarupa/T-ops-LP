      ...
      >
        <div className="flex flex-col items-center justify-center max-w-[540px] mx-auto mb-16">
          <div className="flex justify-center">
            <div className="border border-[#dadada] py-1 px-4 rounded-full text-xs font-semibold tracking-wide uppercase text-[#121212] opacity-70 bg-[#f7f7f9] transition-colors">
              Testimonials
            </div>
          </div>

          <h2 id="testimonials-heading" className="text-4xl md:text-5xl font-extrabold tracking-tight mt-6 text-center text-[#121212] transition-colors">
            What our users say
          </h2>
          <p className="text-center mt-5 text-[#121212] opacity-60 text-lg leading-relaxed max-w-sm transition-colors">
